...
class SimulateTransactionsCommandTestCase(TestCase):
    ...
    def test_simulate_transactions_command(self):
        ...
        num_minutes = 5  # Provide the desired value for num_minutes (optional)

        call_command('simulate_profit_loss', f'--num_minutes={num_minutes}')
        ...
        self.assertEqual(self.trader1.transactions.count(), num_minutes)  # Assuming num_minutes minutes
        self.assertEqual(self.trader2.transactions.count(), num_minutes)
